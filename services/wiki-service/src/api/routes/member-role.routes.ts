...
/** Only BUREAUCRAT may assign/revoke roles for other members — role management IS this role's stated responsibility per the SRS. */
 ...
 *   get:
 *     summary: List a member's roles in the wiki module (self or BUREAUCRAT)
 *     tags: [Members, Roles]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 * /members/{userId}/roles:
 *   post:
 *     summary: Assign a role to a member (BUREAUCRAT only)
 *     tags: [Members, Roles]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 *   delete:
 *     summary: Revoke a role from a member (BUREAUCRAT only)
 *     tags: [Members, Roles]
 *     security: [{ bearerAuth: [] }]
 *     responses:
