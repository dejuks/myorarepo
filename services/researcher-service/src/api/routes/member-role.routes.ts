...
const TOP_ROLE = 'PLATFORM_ADMINISTRATOR';

/**
 * @openapi
 * /members/{userId}/roles:
 *   get:
 *     summary: List a member's roles in this module (self or PLATFORM_ADMINISTRATOR)
 *     tags: [Members, Roles]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 * /members/{userId}/roles:
 *   post:
 *     summary: Assign a role to a member (PLATFORM_ADMINISTRATOR only)
 *     tags: [Members, Roles]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 *   delete:
 *     summary: Revoke a role from a member (PLATFORM_ADMINISTRATOR only)
 *     tags: [Members, Roles]
 *     security: [{ bearerAuth: [] }]
 *     responses:
